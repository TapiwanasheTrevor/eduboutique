    ...
    <div>
        ...
        <div className="container-custom">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/shop" className="bg-white text-primary-700 px-8 py-4 rounded-lg font-semibold hover:bg-primary-50 transition-colors inline-flex items-center justify-center">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link to="/shop?category=zimsec" className="group">
            ...
            <Link to="/shop?category=cambridge" className="group">
              <div className="card p-6 text-center hover:shadow-hover transition-shadow">
            ...
            <Link to="/shop?category=stationery" className="group">
              <div className="card p-6 text-center hover:shadow-hover transition-shadow">
            ...
            <Link to="/shop?category=supplementary" className="group">
              <div className="card p-6 text-center hover:shadow-hover transition-shadow">
      ...
      <section className="py-16 bg-primary-700 text-white">
        <div className="container-custom text-center">
          ...
          <Link to="/about" className="bg-white text-primary-700 px-8 py-4 rounded-lg font-semibold hover:bg-primary-50 transition-colors inline-block">
            Learn More About Us
          </Link>
        </div>
      </section>
