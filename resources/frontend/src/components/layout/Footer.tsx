        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/shop?category=zimsec" className="hover:text-white transition-colors">
                  ZIMSEC Textbooks
                </Link>
              </li>
              <li>
                <Link to="/shop?category=cambridge" className="hover:text-white transition-colors">
                  Cambridge Textbooks
                </Link>
              </li>
              <li>
                <Link to="/shop?category=stationery" className="hover:text-white transition-colors">
                  Stationery
                </Link>
              </li>
              <li>
                <Link to="/shop?category=supplementary" className="hover:text-white transition-colors">
                  Supplementary Books
                </Link>
              </li>
            </ul>
